...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // CCz: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // CCz: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // CCz: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // 1 Oz of CCz: 2.5 minutes
