...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CCz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "ccz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "ccz.bitcommoditiz.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "testnet.ccz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "testnet.ccz.bitcommoditiz.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CCz is probably already running."), addrBind.ToString().c_str());
        else
